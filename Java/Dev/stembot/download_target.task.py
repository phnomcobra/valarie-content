...
PARENT_UUID = "b966694c-9026-c5c6-7820-d23681e9c0e9"

REMOTE_FS_PATH = "/tmp/stembot/target"

TXT_EXTENSIONS = ["properties", "lst", "pem", "yaml", "xml"]
BIN_EXTENSIONS = ["class", "jks", "jar", "original"]
