...
PARENT_UUID = "186e6983-c7d6-b490-e2d2-e5e2670e8ee0"

REMOTE_FS_PATH = "/tmp/root-ca"

TXT_EXTENSIONS = ["py", "html", "pem", "js", "md", "css", "json", "map", "csv", "txt", "csr"]
BIN_EXTENSIONS = ["png", "svg", "gif", "jpg", "ttf", "woff", "woff2", "eot", "jks"]
